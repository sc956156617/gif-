 ...
 *  代理
 */
@protocol SCLoopDelegate <NSObject>
 ...
 *  @param index     图片索引
 */
- (void)loopView:(SCLoop *)loopView clickImageAtIndex:(NSInteger)index;
 ...
 *  代理，用来处理图片的点击
 */
@property (nonatomic, weak) id<SCLoopDelegate> SCDelegate;
